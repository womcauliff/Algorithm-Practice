...
public class CE {
     ...
     * @return The array of Integers that the two arrays have in common.
     * If none are found, returns an empty ArrayList.
     */
    public static Integer[] commonElements(int[] array1, int[] array2) {
        ...
        int currentValue = CE.returnLesser(
            array1[0],
            array2[0]
        );
        ...
        while (index1 < array1.length && index2 < array2.length) {
            ...
            if (array1[index1] == array2[index2]) {
                result.add(new Integer(currentValue));
            }
     ...
     * @return The lesser of the two numbers, or num1 if
